...
try {
  ...
  // なっていた。
  execSync('git add VERSION package.json src/editor.js src/blocks.js src/editor.css src/content.css public/sample/index.html public/index.html README.md README.ja.md tests', { cwd: root, stdio: 'inherit' })
